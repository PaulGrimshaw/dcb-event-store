...
- **Latency targets**: TBC — pending benchmarks under representative load
...
Reasonable performance TBC — benchmarks pending real-world measurement under representative load.
