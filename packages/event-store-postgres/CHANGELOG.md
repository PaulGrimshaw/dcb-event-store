...
- Include README in published packages and streamline release script
- Updated dependencies
    - @dcb-es/event-store@7.0.1

## 7.0.0

### Patch Changes

- 99ef932: Fix: subscribers could silently lose events under concurrent out-of-order commits against the Postgres adapter (issue #89).
...
- dce088c: Improvements and bugfixes to new MAJOR version pre-release
- Updated dependencies [99ef932]
- Updated dependencies [dce088c]
    - @dcb-es/event-store@7.0.0
...
- Improvements and bugfixes to new MAJOR version pre-release
- Updated dependencies [99ef932]
- Updated dependencies
    - @dcb-es/event-store@7.0.0-alpha.3
